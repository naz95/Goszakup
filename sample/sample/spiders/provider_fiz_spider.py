...
class MySpider(CrawlSpider):
    name = "provider_fiz_spider"

    def start_requests(self):
        for i in range(1, 2): # na samom dele 2215 stranic
            url="https://v3bl.goszakup.gov.kz/ru/register/supplierreg?name_bin_iin_rnn=&country=&region_supplier=&attribute=3&is_fizface=1&page=%d" % i
